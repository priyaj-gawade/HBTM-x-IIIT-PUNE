# Project Behavioral Rules: Ponytail & Karpathy Mode
...
- **No Unrequested Abstractions:** Do not create wrappers, factories, or extra layers unless explicitly requested.
- **Root Cause, Not Symptom:** Fix the shared root cause once rather than patching multiple call sites.
- **Shortest Working Diff Wins:** Deletion over addition. Boring over clever. Fewest files possible.

---

## Karpathy Principles
1. **Think Before Coding:** Never make silent assumptions. State assumptions and clarify ambiguities early.
...
4. **Goal-Driven Execution:** Define clear success criteria and verify with real commands/tests before finishing.
